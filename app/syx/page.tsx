...
export default function SyxPage() {
              ...
              <div className="p-6 sm:p-8 md:p-12">
                ...
                <div className="relative text-black font-serif">
                  <div className="text-center mb-4 sm:mb-6">
                    <p className="text-lg sm:text-xl font-bold text-black mb-2">致 SYX</p>
                    ...
                    <>
                      <div className="text-xs sm:text-sm leading-loose text-justify space-y-3 sm:space-y-4">
                        <p className="indent-8">
                          <AnimatedSentence sentence="亲爱的你，当我写下这些文字时，心中满是激动和幸福。" delay={0} />
                          <AnimatedSentence sentence="12月30日，这个特别的日子，我们终于在一起了。" delay={2} />
                          <AnimatedSentence sentence="虽然你在职高，我在普高，我们不在同一所学校，但这并不能阻挡我对你的爱。" delay={4} />
                        </p>
                        
                        <p className="indent-8">
                          <AnimatedSentence sentence="从认识你的那一刻起，我就知道你是特别的。" delay={6} />
                          <AnimatedSentence sentence="你的笑容，你的温柔，你的善良，都深深吸引着我。" delay={8} />
                          <AnimatedSentence sentence="即使我们不能每天见面，但我的心永远和你在一起。" delay={10} />
                        </p>
                        
                        <p className="indent-8">
                          <AnimatedSentence sentence="我知道异校恋会有很多困难，见面的时间会很少。" delay={12} />
                          <AnimatedSentence sentence="但我相信，只要我们彼此信任，彼此珍惜，距离不是问题。" delay={14} />
                          <AnimatedSentence sentence="我会在每个周末等你，会在每个假期陪你，会用我的全部去爱你。" delay={16} />
                        </p>
                        
                        <p className="indent-8">
                          <AnimatedSentence sentence="我会努力学习，让自己变得更好，配得上你。" delay={18} />
                          <AnimatedSentence sentence="我会在你需要的时候第一时间出现，做你最坚实的后盾。" delay={20} />
                          <AnimatedSentence sentence="无论未来如何，我都会牵着你的手，一起走下去。" delay={22} />
                        </p>
                        
                        <p className="indent-8">
                          <AnimatedSentence sentence="谢谢你愿意成为我的女朋友，给我这个机会好好爱你。" delay={24} />
                          <AnimatedSentence sentence="我会珍惜我们在一起的每一天，每一刻。" delay={26} />
                          <AnimatedSentence sentence="我爱你，石雨馨，永远爱你。" delay={28} />
                        </p>
                      </div>
